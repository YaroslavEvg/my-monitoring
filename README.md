...
Если у маршрута есть `children`, их результаты сохраняются во вложенном поле `children` внутри соответствующего маршрута.
