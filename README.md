...
| `file.zip_enabled` | `false` | Включает автоматическую сборку zip из файла/папки перед отправкой. |
...
| `file.zip_enabled` | ✖ | Упаковать файл/каталог в zip перед отправкой. Для каталогов требуется `true`; для файлов можно отправлять как есть или в zip. |
